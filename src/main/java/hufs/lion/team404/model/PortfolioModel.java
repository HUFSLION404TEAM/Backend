...
public class PortfolioModel {
    ...
    // 생성
    public Long createPortfolio(String title, String progressPeriod, Boolean prize, String workDoneProgress, String result,
    ...
    public Long updatePortfolio(Long portfolioId, String title, String progressPeriod, Boolean prize,
        ...
        if (progressPeriod != null)  portfolio.setProgressPeriod(progressPeriod);
        if (prize != null)           portfolio.setPrize(prize);
        if (workDoneProgress != null)portfolio.setWorkDoneProgress(workDoneProgress);
        if (result != null)          portfolio.setResult(result);
        if (felt != null)            portfolio.setFelt(felt);
        if (isPrivate != null)       portfolio.setPrivate(isPrivate);
